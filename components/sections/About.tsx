        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            <h2 className="text-4xl font-heading font-bold text-foreground mb-6">
              {t('about.title_line1')} <span className="text-accent">{t('about.title_highlight1')}</span>,<br />
              {t('about.title_line2')} <span className="text-neon">{t('about.title_highlight2')}</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-8">
              {stats.map((stat, idx) => (
                <div key={idx}>
                  <p className="text-3xl font-bold text-foreground mb-1 font-heading">{stat.value}</p>
                  <p className="text-sm text-accent/80 uppercase tracking-wide font-sans">{stat.label}</p>
                </div>
              ))}
            </div>
          </motion.div>
