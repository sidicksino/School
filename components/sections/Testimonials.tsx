...
export const Testimonials: React.FC = () => {
  ...
  const reviews = t('testimonials.items') as unknown as Array<{name: string, role: string, text: string}>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((review, idx) => (
            ...
            >
              ...
              <p className="text-muted italic mb-8 leading-relaxed font-sans">
                "{review.text}"
              </p>
