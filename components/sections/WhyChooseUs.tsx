      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {items.map((item, idx) => (
            ...
            >
              <div className={`mb-6 p-4 rounded-xl bg-secondary dark:bg-primary/50 inline-block ${features[idx].color} group-hover:scale-110 transition-transform shadow-sm`}>
                {features[idx].icon}
              </div>
